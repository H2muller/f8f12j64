...
parser.add_argument('-f', required=True, metavar='', dest='f', help='path to input file in FASTA format')
parser.add_argument('-g', required=True, metavar='', dest='f', help='path to input file in GFF format')
# parser.add_argument('-n', '--number', metavar='', dest='n', type=int, default=5, help='number of candidate primer pairs to pick, default = 5')
parser.add_argument('-o', '--output', metavar='', dest='o', default='output.fasta', help='path to output file')
